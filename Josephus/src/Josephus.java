 ...
 *  in a circle (at positions numbered from 0 to N-1) and proceed 
 *  around the circle, eliminating every Mth person until only one 
 *  person is left. Legend has it that Josephus figured out where 
 *  to sit to avoid being eliminated. Write a Queue client Josephus.java
...
public class Josephus {
	public static void main(String[] args) {
		...
		while (!queue.isEmpty()) {
			...
			StdOut.print("apres " + queue.dequeue());
		}
		StdOut.println();
	}
}